...
*/
Vue.component("fixed_left_side_hero_component_1721714135", {
    template: `
            ...
            <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20 flex-1" id="quote-header">
                <div class="grow flex flex-col justify-center" id="quote-content">
                    <div class="space-y-3" id="quote-container">
                        ...
                        <h1 id="company-name" class="h1 font-orbiter font-bold" :class="heroTitleStyle">Real-Time Ethereum Transaction Tracker</h1>
                        <time id="quote-date" class="block font-caveat text-xl" :class="heroSubtitleStyle">Stay ahead of the curve with our powerful Ethereum transaction monitoring app.</time>
                    </div>
                </div>
            </div>
        </div>
