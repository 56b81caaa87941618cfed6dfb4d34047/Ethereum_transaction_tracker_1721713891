...
Vue.component("quoty_faq_accordion_component_1721714158", {
    template: `
    <section class="py-8 bg-white pl-4">
        <h2 class="text-lg font-semibold mb-5">Frequently Asked Questions about EtherScan</h2>
        <!-- Accordion -->
        <div class="space-y-3">
            <!-- Accordion item -->
    ...
    data() {
        return {
            ...
            terms: [
                { title: "What is EtherScan?", description: "EtherScan is a blockchain explorer and analytics platform for Ethereum. It allows you to explore and search the Ethereum blockchain, view transaction details, check smart contract code, and more.", expanded: false },
                { title: "How can I find new Ethereum transactions?", description: "EtherScan has a 'Latest Transactions' section that shows the most recent transactions on the Ethereum network in real-time. You can also set up alerts to be notified of new transactions to specific wallet addresses or contracts.", expanded: false },
                { title: "Is EtherScan free to use?", description: "Yes, EtherScan is free to use for basic features like viewing transactions and balances. However, there are paid plans available for advanced data APIs and analytics tools for developers and businesses.", expanded: false },
                { title: "Is my data private when using EtherScan?", description: "All data on the Ethereum blockchain is public by design. EtherScan does not collect or store any private user data beyond basic analytics. However, you should still take precautions like using a secure wallet and VPN.", expanded: false },
            ],
        };
    },
    methods: {
