Vue.component('faq_accordion_1721714150', {
  template: `
    <div>
      <section class="leading-relaxed max-w-screen-xl mt-12 mx-auto px-4 md:px-8 bg-white">
        <div class="space-y-3 text-center">
          <h1 class="text-4xl text-gray-800 font-semibold pt-10">Ethereum Transaction Explorer FAQ</h1>
          <p class="text-gray-600 max-w-lg mx-auto text-lg">Get answers to common questions about our app</p>
        </div>
      ...
      faqs: [
        {
          ...
          a: "Our app allows you to easily explore and monitor new transactions on the Ethereum blockchain in real-time."
        },
        {
          q: "How does it work?",
          a: "We connect directly to Ethereum nodes to stream incoming transactions as they get added to new blocks. Our algorithms quickly parse and index this data for fast querying."
        },
        {
          q: "What kind of transactions can I see?",
          a: "You can view details on all kinds of Ethereum transactions including token transfers, smart contract deployments/executions, and basic ETH transfers between wallets."
        },
        {
          q: "Is this service free?",
          a: "Yes, our basic transaction monitoring is free to use. We offer premium paid plans with additional filtering, notification, and data export features."
        },
        {
          q: "How can I get started?",
          a: "Just sign up for a free account on our website. The onboarding flow will guide you through connecting to the Ethereum networks you want to monitor."
        }
      ]
    }
  },
